...
public class EmployeeController {
	...
	employee.setStateName(employeeDetails.getStateName());
	employee.setCountryName(employeeDetails.getCountryName());
	employee.setCityName(employeeDetails.getCityName());
	employee.setPincode(employeeDetails.getPincode());
	employee.setEmpcode(employeeDetails.getEmpcode());
	employee.setAlternatePhNumber(employeeDetails.getAlternatePhNumber());
